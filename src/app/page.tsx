            ...
            >
              ...
              >
                <motion.a
                  ...
                  className="px-8 py-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 inline-flex items-center"
              ...
              {[
                {
                  ...
                  description: 'Encontre pessoas desaparecidas usando nossos filtros avançados de busca.',
                  color: 'blue'
                },
                {
                  icon: (
                  ...
                  description: 'Colabore com o portal inserindo mais informações sobre o desaparecimento.',
                  color: 'green'
                }
              ].map((feature, index) => (
                <motion.div 
                  ...
                  whileHover={{ y: -5 }}
                >
                  <div className={`w-16 h-16 bg-${feature.color}-100 dark:bg-${feature.color}-900/20 rounded-2xl flex items-center justify-center mb-6 mx-auto`}>
                    {feature.icon}
                  </div>
