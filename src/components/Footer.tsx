      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
          <motion.div variants={item}>
            ...
            >
              Ajudando a encontrar pessoas desaparecidas em Mato Grosso. Juntos, podemos fazer a diferença.
            </motion.p>
          ...
          <motion.div variants={item} className="md:pl-8">
            ...
            >
              {[
                { name: 'Início', href: '/' },
                { name: 'Pessoas Desaparecidas', href: '/pessoas-desaparecidas' },
              ].map((link, index) => (
                <motion.li 
                  key={link.name}
                  variants={{
                ...
                >
                  ...
                  >
                    <motion.span 
                      className="w-2 h-2 bg-blue-500 rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity"
                      initial={{ scale: 0 }}
                      whileInView={{ scale: 1 }}
                      viewport={{ once: true }}
              ...
              {[
                {
                  ...
                  text: 'contato@desenvolvemt.com.br',
                  href: 'mailto:contato@desenvolvemt.com.br'
                },
                {
                  icon: 'M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z',
                  text: '+55 (65) 99999-9999',
                  href: 'tel:+5565999999999'
                },
                {
                  icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z',
                  text: 'Cuiabá - MT, Brasil',
        ...
        >
          <p>&copy; {new Date().getFullYear()} Desenvolve MT. Todos os direitos reservados.</p>
          <p className="mt-2 text-sm text-gray-500">Desenvolvido com ❤️ para ajudar famílias de Mato Grosso</p>
        </motion.div>
      </div>
    </motion.footer>
  );
